...
def unique_source_urls(chunks):
    """Return a set of unique origin URLs from Document chunks."""
    return set(chunk.metadata.get('origin_url') for chunk in chunks if 'origin_url' in chunk.metadata)
